...
import 'tambah_sektor_page.dart'; // Import halaman TambahCabangPage
import 'edit_sektor_page.dart'; // Import halaman EditCabangPage
import 'hapus_sektor_page.dart'; // Import halaman HapusCabangPage

class DataSektorPage extends StatelessWidget {
  @override
                          ...
                          _buildButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => TambahSektorPage(),
                                ),
                              );
                            },
                          ...
                          _buildButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => EditSektorPage(),
                                ),
                              );
                            },
                          ...
                          _buildButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => HapusSektorPage(),
                                ),
                              );
                            },
