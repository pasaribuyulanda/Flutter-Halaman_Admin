...
import 'tambah_regional_page.dart'; // Import halaman TambahCabangPage
import 'edit_regional_page.dart'; // Import halaman EditCabangPage
import 'hapus_regional_page.dart'; // Import halaman HapusCabangPage

class DataRegionalPage extends StatelessWidget {
  @override
                          ...
                          _buildButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => TambahRegionalPage(),
                                ),
                              );
                            },
                            color: const Color.fromARGB(255, 19, 138, 23),
                            icon: Icons.add,
                            tooltip: 'Tambah',
                          ),
                          SizedBox(width: 8.0),
                          _buildButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => EditRegionalPage(),
                                ),
                              );
                            },
                          ...
                          _buildButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => HapusRegionalPage(),
                                ),
                              );
                            },
                            color: Color.fromARGB(255, 170, 14, 32),
                            icon: Icons.delete,
                            tooltip: 'Hapus',
                          ),
                        ],
