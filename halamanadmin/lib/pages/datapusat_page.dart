...
import 'tambah_pusat_page.dart'; // Import halaman TambahCabangPage
import 'edit_pusat_page.dart'; // Import halaman EditCabangPage
import 'hapus_pusat_page.dart'; // Import halaman HapusCabangPage

class DataPusatPage extends StatelessWidget {
  @override
                          ...
                          _buildButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => TambahPusatPage(),
                                ),
                              );
                            },
                          ...
                          _buildButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => HapusPusatPage(),
                                ),
                              );
                            },
