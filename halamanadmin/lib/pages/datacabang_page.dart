...
import 'tambah_cabang_page.dart'; // Import halaman TambahCabangPage
import 'edit_cabang_page.dart'; // Import halaman EditCabangPage
import 'hapus_cabang_page.dart'; // Import halaman HapusCabangPage

class DataCabangPage extends StatelessWidget {
  @override
                          ...
                          _buildButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => EditCabangPage(),
                                ),
                              );
                            },
                          ...
                          _buildButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => HapusCabangPage(),
                                ),
                              );
                            },
